...
% \gck@after@rubyfalse
% \newcommand\gck@maybe@kanjiskip{%
%   \ifgck@after@ruby % 直前が ruby-box
%     \ifnum\lastnodetype=37\else%
%       \hspace{\ltjgetparameter{kanjiskip}}%
%     \fi%
%   \fi%
% }
...
\begin{GCKEnv}{2\zw}
  ...
  \振り{者}{は}\送り{ノ}\振り{者}{は}\送り{ノ}\振り{者}{は}\振り{者}{は}\振り{者}{は}\振り{者}{は}\振り{者}{は}\振り{者}{は}\振り{者}{は}\\

  \fbox{\makebox[10\zw][s]{\振り{者}{は}\振り{者}{は}\振り{者}{は}}}
  \fbox{\makebox[10\zw][s]{あああ}}
\end{GCKEnv}
...
% \fbox{\makebox[10\zw][s]{\gck@maybe@kanjiskip\振り{者}{は}\gck@after@rubytrue@if%
% \gck@maybe@kanjiskip\振り{者}{は}\gck@after@rubytrue@if%
% \gck@maybe@kanjiskip\振り[intrusion=post]{者}{はああああああ}}\gck@maybe@kanjiskip}

% \fbox{\makebox[10\zw][s]{\振り{者}{は}\振り{者}{は}\振り[intrusion=post]{者}{はああああああ}}}
\end{document}
