...
% \fbox{\makebox[10\zw][s]{\振り{者}{は}\送り{ニ}\hspace{\ltjgetparameter{kanjiskip}}\振り{者}{は}}\hspace{\ltjgetparameter{kanjiskip}}}
\fbox{\makebox[10\zw][s]{\振り[intrusion=both]{春}{しゅん}
    \振り[intrusion=both]{眠}{みん}%
    不\返り[intrusion=both]{レ}%
    \振り{覚}{おぼ}\送り{エ}\返り[intrusion=both]{レ}%
    \振り{暁}{あかつき}\送り[intrusion=post]{ヲ}}}
\fbox{\makebox[10\zw][s]{\振り[intrusion=both]{春}{しゅん}
    \振り{眠}{みん}あ\振り{春}{しゅん}ああ}}


\parbox{6\zw}{\Huge は、ああああああ}
